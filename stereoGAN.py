...
def load_examples():
    ...
    with tf.name_scope("load_images"):
        ...
        raw_input_L = tf.image.crop_to_bounding_box(raw_input_L, 77, 77, 256)
        raw_input_R = tf.image.crop_to_bounding_box(raw_input_R, 77, 77, 256)
        raw_input_depth = tf.image.crop_to_bounding_box(raw_input_depth, 77, 77, 256)
