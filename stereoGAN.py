...
def load_examples():
    ...
    with tf.name_scope("load_images"):
        ...
        # raw_input_L.set_shape([480, 480, 1]) #Set the image channels size to be 2
        # raw_input_R.set_shape([480, 480, 1])
        # raw_input_depth.set_shape([480, 480, 1])
        ...
        raw_input_L = tf.image.resize_images(raw_input_L, size=(410,410), method=tf.image.ResizeMethod.BILINEAR)
        raw_input_R = tf.image.resize_images(raw_input_R, size=(410,410), method=tf.image.ResizeMethod.BILINEAR)
        raw_input_L = tf.image.crop_to_bounding_box(raw_input_L, 77, 77, a.scale_size,a.scale_size)
        raw_input_R = tf.image.crop_to_bounding_box(raw_input_R, 77, 77, a.scale_size,a.scale_size)
        raw_input_depth = tf.image.resize_images(raw_input_depth, size=(a.scale_size,a.scale_size), method=tf.image.ResizeMethod.BILINEAR)
        # raw_input_depth = tf.image.crop_to_bounding_box(raw_input_depth, 77, 77, 256,256)
